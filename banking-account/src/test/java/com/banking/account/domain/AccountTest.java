...
class AccountTest {
    ...
    class Debit {
        ...
        @Test
        void reducesBalanceAndAvailable() {
        ...
        @Test
        void exceedsAvailableBalance_throwsInsufficientFunds() {
        ...
        @Test
        void exceedsSingleTransactionLimit_throwsPaymentException() {
        ...
        @Test
        void closedAccount_throwsAccountInactive() {
        ...
        class Credit {
            ...
            @Test
            void increasesBalanceAndAvailable() {
        ...
        class Holds {
            ...
            @Test
            void placeHold_reducesAvailableNotBalance() {
            ...
            @Test
            void placeHold_exceedingAvailable_throwsInsufficientFunds() {
                assertThatThrownBy(() -> account.placeHold(new BigDecimal("15000.00")))
                        .isInstanceOf(InsufficientFundsException.class);
            }

            @Test
            void multipleHolds_accumulate() {
            ...
            @Test
            void partialRelease_reducesHoldCorrectly() {
            ...
            @Test
            void releaseMoreThanHeld_holdsFloorAtZero() {
                account.placeHold(new BigDecimal("1000.00"));
        ...
        @Nested
        @DisplayName("isActive / hasSufficientFunds")
        class StatusHelpers {

            @Test
            void isActive_true_forActiveAccount() {
            ...
            @Test
            void hasSufficientFunds_true_forExactAmount() {
            ...
            @Test
            void hasSufficientFunds_accountsForExistingHolds() {
        ...
        @Nested
        @DisplayName("Full payment lifecycle (hold → release → debit → credit)")
        class PaymentLifecycle {

            @Test
            void holdThenDebitThenCredit_maintainsCorrectState() {
                // 1. Place hold
            ...
            @Test
            void fraudFail_releaseHoldRestoresFunds() {
                account.placeHold(new BigDecimal("5000.00"));
